...
@param resolution a measure of accuracy; the desired number of subintervals per interval. 
*/
public synchronized MightyStaticBin1D[] splitApproximately(cern.hep.aida.IAxis axis, int k) {
	DoubleArrayList percentages = new DoubleArrayList(new cern.hep.aida.ref.Converter().edges(axis));
