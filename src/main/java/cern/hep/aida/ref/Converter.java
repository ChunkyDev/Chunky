...
import cern.hep.aida.IAxis;
import cern.hep.aida.IHistogram1D;
import cern.hep.aida.IHistogram2D;
import cern.hep.aida.IHistogram3D;
...
public class Converter
{
	...
	{		
		...
		cern.hep.aida.bin.BinFunction1D[] aggr = null; //{cern.hep.aida.bin.BinFunctions1D.sum};
		String format = "%G";
		//String format = "%1.2G";
	...
	{		
		...
		cern.hep.aida.bin.BinFunction1D[] aggr = {cern.hep.aida.bin.BinFunctions1D.sum};
		String format = "%G";
		//String format = "%1.2G";
