...
cern.hep.aida.bin.DynamicBin1D bin = new cern.hep.aida.bin.DynamicBin1D();
...
public static void test2(int size, AbstractDistribution a, AbstractDistribution b) {
	cern.hep.aida.bin.DynamicBin1D binA = new cern.hep.aida.bin.DynamicBin1D();
	cern.hep.aida.bin.DynamicBin1D binB = new cern.hep.aida.bin.DynamicBin1D();
	for (int j=0, i=size; --i>=0; j++) {
