...
public enum Language {
    ...
    CMD_CHUNKY_PERMISSION_SET_DESC("command.chunky_permission_set_desc", "Allows you to set permissions for other players and eventually groups.", 0),
    CMD_CHUNKY_PERMISSION_SET_HELP("command.chunky_permission_set_help",
            Arrays.asList("&eUsage: /chunky permission set [*:][+/-]<flags/clear> [player]",
    ...
    HELP ("help", "[Help]", 0),
    NO_PERMISSIONS_SET("no_permissions_set", "NONE", 0),
