...
public class ChunkyObjectNameEvent extends ChunkyObjectEvent implements Cancellable {
    ...
    public ChunkyObjectNameEvent(final IChunkyObject object, final String newName) {
    ...
    public ChunkyObjectNameEvent(final ChunkyEvent.Type type, final IChunkyObject object, final String newName) {
        super(type, object);
        this.object = object;
        this.oldName = object.getName();
        this.newName = newName;
