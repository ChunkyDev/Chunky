...
public class QueryGen {
    ...
    public static String updateObject(IChunkyObject object) {
    ...
    public static String updatePermissions(IChunkyObject permissible, IChunkyObject object, PermissionRelationship perms) {
    ...
    public static String removePermissions(IChunkyObject permissible, IChunkyObject object) {
        return
    ...
    public static String removeAllPermissions(IChunkyObject object) {
        return
                format("DELETE FROM chunky_permissions where " +
                        "ObjectType = '%s'" +
    ...
    public static String addGroupMember(IChunkyGroup group, IChunkyObject member) {
        return
    ...
    public static String removeGroupMember(IChunkyGroup group, IChunkyObject member) {
        return
    ...
    public static String removeGroup(IChunkyGroup group) {
        return
                format("DELETE FROM chunky_groups where " +
                        "GroupType = '%s'" +
    ...
    public static String addOwnership(IChunkyObject owner, IChunkyObject ownable) {
        return
    ...
    public static String removeOwnership(IChunkyObject owner, IChunkyObject ownable) {
        return
